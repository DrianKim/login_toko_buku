...
@section('content')
    <h1 class="mb-4">Edit Kategori Buku</h1>

    <form action="{{ route('admin.kategori.update', $kategori_buku->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" id="kategori" name="kategori" class="form-control" required
                        value="{{ old('kategori', $kategori_buku->kategori) }}">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" id="jenis" name="jenis" class="form-control" required
                        value="{{ old('jenis', $kategori_buku->jenis) }}">
                    @if ($errors->has('jenis'))
