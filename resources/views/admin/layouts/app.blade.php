...
<head>
    ...
    <!-- Font & Icons -->
    <link rel="stylesheet" href="https://fonts.bunny.net/css?family=Figtree:400,600,700,800&display=swap">
...
<body x-data="{ openSidebar: true, dropdown: false }" class="bg-gray-50 text-gray-800 font-sans">
    ...
    <aside x-cloak
        ...
        <nav class="flex flex-col gap-2 mb-auto text-sm">
            <a href="{{ route('admin') }}" class="nav-link {{ request()->routeIs('admin') ? 'active text-indigo-600 font-semibold' : 'text-gray-600 hover:text-indigo-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
                <i class="fa-solid fa-gauge-high"></i> Dashboard
            </a>
            <a href="{{ route('admin.data-buku') }}" class="nav-link {{ request()->routeIs('admin.data-buku') ? 'active text-indigo-600 font-semibold' : 'text-gray-600 hover:text-indigo-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
                <i class="fa-solid fa-book"></i> Data Buku
            </a>
            <a href="{{ route('admin.kategori-buku') }}" class="nav-link {{ request()->routeIs('admin.kategori-buku') ? 'active text-indigo-600 font-semibold' : 'text-gray-600 hover:text-indigo-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
                <i class="fa-solid fa-tags"></i> Kategori Buku
            </a>
            <a href="{{ route('admin.detail-buku') }}" class="nav-link {{ request()->routeIs('admin.detail-buku') ? 'active text-indigo-600 font-semibold' : 'text-gray-600 hover:text-indigo-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
                <i class="fa-solid fa-book-open"></i> Detail Buku
            </a>
            <a href="{{ route('admin.users.index') }}" class="nav-link {{ request()->routeIs('admin.users.*') ? 'active text-indigo-600 font-semibold' : 'text-gray-600 hover:text-indigo-600 hover:bg-gray-50' }} flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
