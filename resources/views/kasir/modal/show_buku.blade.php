    ...
    <div class="bg-white w-full max-w-3xl rounded-2xl shadow-xl overflow-hidden relative animate-fadeIn">
        ...
        <div
            ...
            <button type="button"
                ...
                data-modal-close="showBukuModal{{ $item->id }}">
